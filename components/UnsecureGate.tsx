...
const UnsecureGate = () => (
    <div style={{
        ...
        <p className="text-size-large text-align-center">If you see this page, you may be accessing Eco ID through a malicious site.</p>
        <br/>
        <Link href={window.self.location.href}>Visit Eco ID safely</Link>
    </div>
)

export default UnsecureGate;